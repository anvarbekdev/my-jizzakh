...
const Service2 = () => {
  ...
  return (
    <>
      <div className=" text-center text-white font-semibold text-3xl mb-6">
      {t("news")}
      </div>
      <div id="news" className="sm:flex-col flex  lg:flex-row justify-between  my-6 ">
        {/* ===================== News  ==================== */}
        <div className="post-card mb-2 md:mx-4">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReOt6XJ8OgesiHRowZbukXGfHDpKn_jDL-pPcn5I_Ndg&s"
            className="avatar"
          ></img>
          <a className="title" href="#">
            Жиззах вилоят соғлиқни сақлаш бошқармаси Зоминдаги Дуоба оилавий
            поликлиникасида сайёр қабул ва тиббий кўрик ўтказди
          </a>
          <span className="datetime">6 min to read</span>
          <img
            src="https://jizzax.uz/uploads/posts/2023-06/1686247455_2023-06-08_230108.jpg"
        ...
        <div className="post-card mb-2 md:mx-4">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEJuOqDYeLdcJOq8OctOVOCWp-RTFkdmWK4dcI5F9YLg&s"
            className="avatar"
          ></img>
          <a className="title" href="#">
            O'zbekiston - yuzdan ortiq turli millat va elatlar vakillari
            yashaydigan, urf-odatlari va madaniyati o'ziga xos mamlakat.
          </a>
          <span className="datetime">3 hours to read</span>
          <img
            src="https://jizzax.uz/uploads/posts/2020-02/1581502596_sanatoriya.jpg"
            className="image-preview"
          ></img>
          <div className="comment-like">
            <span>
        ...
        <div className="post-card mb-2 md:mx-4">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL9HiqSX6YyCc75TWaveyuURZB75eOr1ly6Y_WWiHt&s"
            className="avatar"
          ></img>
          <a className="title" href="#">
            Жиззахда миллатлараро тотувлик борасида амалга оширилаётган ишлар
            бўйича матбуот анжумани ўтказилди
          </a>
          <span className="datetime">20 min to read</span>
          <img
            src="https://jizzax.uz/uploads/posts/2023-05/1685536666_2023-05-31_173516.jpg"
            className="image-preview"
          ></img>
          <div className="comment-like">
            <span>
